# clopr2-secure-hybrid-dr-gateway
## Project Identity (CLOPR2)
- **Owner (IAMCODE):** KATAR711
- **Team tag:** BCLC24
- **Compliance:** EU regions/services only
...
Hybrid Azure + Proxmox DR gateway with AKS, Terraform/Ansible IaC, Zero-Trust security (Entra ID, Key Vault, Defender) and centralized monitoring in Azure.
