...
| US5 DB DR | DB primary on-prem + standby replica + VIP; Azure VM DR replica; connectivity tests from both environments; teacher approval (cost caution) | [docs/05-evidence/outputs/](docs/05-evidence/outputs/), [docs/05-evidence/screenshots/](docs/05-evidence/screenshots/), [docs/05-evidence/screenshots/teacher-approval-cost-caution.png](docs/05-evidence/screenshots/teacher-approval-cost-caution.png) | Confirm on-prem VIP, replication status, and Azure DR reachability |
