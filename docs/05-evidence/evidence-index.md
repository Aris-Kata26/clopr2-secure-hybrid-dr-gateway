...
| US9 Security | Key Vault usage + Defender recommendations + NSG rules evidence | [docs/05-evidence/screenshots/defender-enabled.png](docs/05-evidence/screenshots/defender-enabled.png), [docs/05-evidence/screenshots/secure-score.png](docs/05-evidence/screenshots/secure-score.png), [docs/05-evidence/screenshots/recommendations.png](docs/05-evidence/screenshots/recommendations.png) | Verify security controls and recommendations |
